...
import pl.minicode.targowiska.service.OfferService;
	 ...
	 @RequestMapping(value = "/listoffers", method = RequestMethod.GET)
	    public String listBooks(
	      ...
	      @RequestParam("size") Optional<Integer> size) {
	        ...
	        Page<Offer> offers = offerService.findPaginatedOffers(PageRequest.of(currentPage - 1, pageSize));
	 
	        model.addAttribute("offersPage", offers);
